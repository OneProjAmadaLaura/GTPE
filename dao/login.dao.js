                            ...
                            if (continuar) {
                                ...
                                BdObtenerMenu(datos.IdPerfil, entrada.IdUsuario)
                                    .then(function(result) {
                                        ...
                                        logger.info(`${etiquetaLOG} RESPUESTA: ok = ${(numMenu>0)?true:false}, mensaje = ${(numMenu>0)?'Consulta exitosa':'No se encontró información de Menú con el Perfil indicado'}, codigo =  ${(numMenu>0)?codRespuesta.exito:codRespuesta.noDatos}`);
                                        ...
                                        if (numMenu > 0) {
                                            ...
                                            BdObtenerPrivilegios(datos.IdPerfil, entrada.IdUsuario)
                                                .then(function(result) {
                                                    ...
                                                    logger.info(`${etiquetaLOG} RESPUESTA: ok = ${(numMenu>0)?true:false}, mensaje = ${(numMenu>0)?'Consulta exitosa':'No se encontró información de Privilegios con el Perfil indicado'}, codigo =  ${(numMenu>0)?codRespuesta.exito:codRespuesta.noDatos}`);
